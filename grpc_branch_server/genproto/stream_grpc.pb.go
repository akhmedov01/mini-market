...
type StreamServiceClient interface {
	...
	TranslateColor(ctx context.Context, opts ...grpc.CallOption) (StreamService_TranslateColorClient, error)
}
...
func (c *streamServiceClient) Count(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_CountClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/branch_service.StreamService/Count", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Sum(ctx context.Context, opts ...grpc.CallOption) (StreamService_SumClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[1], "/branch_service.StreamService/Sum", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Sqr(ctx context.Context, opts ...grpc.CallOption) (StreamService_SqrClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[2], "/branch_service.StreamService/Sqr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) TranslateColor(ctx context.Context, opts ...grpc.CallOption) (StreamService_TranslateColorClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[3], "/branch_service.StreamService/TranslateColor", opts...)
	if err != nil {
		return nil, err
	}
	x := &streamServiceTranslateColorClient{stream}
	return x, nil
}

type StreamService_TranslateColorClient interface {
	Send(*RequestColor) error
	Recv() (*ResponseColor, error)
	grpc.ClientStream
}

type streamServiceTranslateColorClient struct {
	grpc.ClientStream
}

func (x *streamServiceTranslateColorClient) Send(m *RequestColor) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceTranslateColorClient) Recv() (*ResponseColor, error) {
	m := new(ResponseColor)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type StreamServiceServer interface {
	...
	TranslateColor(StreamService_TranslateColorServer) error
...
func (UnimplementedStreamServiceServer) TranslateColor(StreamService_TranslateColorServer) error {
	return status.Errorf(codes.Unimplemented, "method TranslateColor not implemented")
}
...
func _StreamService_TranslateColor_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StreamServiceServer).TranslateColor(&streamServiceTranslateColorServer{stream})
}

type StreamService_TranslateColorServer interface {
	Send(*ResponseColor) error
	Recv() (*RequestColor, error)
	grpc.ServerStream
}

type streamServiceTranslateColorServer struct {
	grpc.ServerStream
}

func (x *streamServiceTranslateColorServer) Send(m *ResponseColor) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceTranslateColorServer) Recv() (*RequestColor, error) {
	m := new(RequestColor)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "branch_service.StreamService",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "TranslateColor",
			Handler:       _StreamService_TranslateColor_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
